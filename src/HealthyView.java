...
public class HealthyView extends JFrame {
	public HealthyView() {
		...
		JLabel lblNewLabel_1 = new JLabel("Sophi is a 9 on the Hungry Scale");
		panel_3.add(lblNewLabel_1, "2, 2");
		
		JButton btnBobbyIsA = new JButton("Bobby is a 4 on the Hungry Scale");
		btnBobbyIsA.setHorizontalAlignment(SwingConstants.LEFT);
		btnBobbyIsA.setHorizontalTextPosition( SwingConstants.LEFT );
		panel_3.add(btnBobbyIsA, "2, 4");
		
		JButton button_1 = new JButton("Bobby is a 4 on the Hungry Scale");
		button_1.setOpaque(false);
		button_1.setHorizontalTextPosition(SwingConstants.LEFT);
		button_1.setHorizontalAlignment(SwingConstants.LEFT);
		setLabelAppearance(button_1);
		panel_3.add(button_1, "2, 6");
